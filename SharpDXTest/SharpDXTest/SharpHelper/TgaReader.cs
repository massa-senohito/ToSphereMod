            ...
            switch (bitsPerPixel)
            {
              case 8:
                ...
                else if (imageType == 3)
                {
                  for (int x = 0; x < imgWidth; x++)
                  {
                    ...
                    bmpData[4 * (y * imgWidth + x) + 3] = scanline[x];
                  }
                }
                break;
              case 15:
              case 16:
                ...
                for (int x = 0; x < imgWidth; x++)
                {
                  ...
                  Debug.Assert(false, "tga 16のパターンはアルファが計算できません");
                  bmpData[4 * (y * imgWidth + x) + 3] = 0xFF;
                }
                break;
              case 24:
              ...
              switch (bitsPerPixel)
              {
                case 8:
                  ...
                  else if (imageType == 11)
                  {
                    for (int j = 0; j < i; j++)
                    {
                      ...
                      bmpData[4 * (y * imgWidth + x) + 3] = scanline[j];
                      x++;
                      if (x >= imgWidth) { x = 0; y--; }
                    }
                  }
                ...
                case 24:
                  ...
                  for (int j = 0; j < i; j++)
                  {
                    ...
                    bmpData[4 * (y * imgWidth + x) + 3] = scanline[j * 3 + 3];
                    x++;
                    if (x >= imgWidth) { x = 0; y--; }
                  }
                  break;
                ...
                case 8:
                  ...
                  else if (imageType == 11)
                  {
                    for (int j = 0; j < i; j++)
                    {
                      ...
                      bmpData[4 * (y * imgWidth + x) + 3] = (byte)p;
                      x++;
                      if (x >= imgWidth) { x = 0; y--; }
                    }
                  }
